        ...
        <form onSubmit={handleAuth} className="space-y-6" noValidate>
          {!isLogin && (
            <div>
              <input
                ...
                className={cn(
                  "w-full p-3 border rounded-lg focus:ring-2 focus:ring-[#00B4D8] focus:border-transparent transition-all",
                  fullName && !validation.fullName(fullName) && "border-red-300"
                )}
                required
          ...
          <div>
            <input
              ...
              className={cn(
                "w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00B4D8] focus:border-transparent transition-all",
                email && !validation.email(email) && "border-red-300"
              )}
              required
          ...
          <div>
            <input
              ...
              className={cn(
                "w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00B4D8] focus:border-transparent transition-all",
                password && !isLogin && !validation.password(password).isStrong && "border-red-300"
              )}
              required
