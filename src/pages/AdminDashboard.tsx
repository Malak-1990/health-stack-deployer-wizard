...
import { Users, Heart, AlertTriangle, Activity, Database, TrendingUp, Settings, Shield, LogOut } from 'lucide-react';
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div className="mr-3">
                ...
                <p className="text-sm text-gray-600">مشرف النظام: {user?.email}</p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-6 text-white">
            ...
            <div className="mt-4 text-sm bg-white/10 p-3 rounded-lg">
              ...
              <p><strong>صلاحيات كاملة:</strong> إدارة المستخدمين، النظام، والتقارير</p>
            </div>
          </div>
